...
from TipoDocente import Titular
from TiempoContrato import TiempoCompleto
from Patrones.Observer.GestorNotificaciones import GestorNotificaciones
from Patrones.Observer.FormateadorNotificaciones import FormateadorNotificaciones
from datetime import datetime



class Docente(Usuario):
    def __init__(self, cedula, nombre, correo, contrasena, rol, profesion, especialidad, tipoDocente, tiempoContrato):
    ...
    def crearEvaluacion(self, curso_dao, materia_dao, evaluacion_dao, asignacionCurso_dao):
        ...
        materia = materia_dao.buscar(self.idMateria)
        if materia is None:
